...
class OpenGraphImage
  ...
  def title_image
    image_from_text('North West Ruby User Group', size: TITLE_FONT_SIZE, width: TEXT_BLOCK_WIDTH, colour: TITLE_COLOUR)
  end

  # @return [Vips::Image] of the subheading
  def subheading_image
    image_from_text("3rd Thursday of the month\n— Manchester, UK", size: DETAILS_FONT_SIZE, width: TEXT_BLOCK_WIDTH, colour: DETAILS_COLOUR)
  end
